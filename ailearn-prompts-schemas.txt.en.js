      ...
      ims.set('./txt', {
        ...
        creator: function (require, exports) {
          exports.txt = {
            ...
            "defaultValueDependency": "Por favor, defina el valor en la dependencia",
            "form": {
              "subtitle": "Title",
              "subtitleLanguage": "Languages",
              "subtitleDependencies": "Dependencies",
              "subtitleLiterals": "Literals",
              "subtitleText": "Template",
              "subtitlePreview": "Final Prompt",
              "subtitleResponse": "Return",
              "subtitleVariable": "Define variables",
              "submit": "Save",
              "subtitleMetaLiteral": "Select meta data"
            },
            "saveButtonText": "Successfully saved",
            "processButton": "Process",
            "identifierInfo": "This element has a unique identifier that is automatically generated and cannot be modified. 🏷️",
            "languages": {
              "title": "Supported",
              "updated": "Updated",
              "es": "Spanish",
            ...
            "import": {
              "title": "Translation of Prompt to a New Language",
              "description": "This prompt already contains information in another language. If you wish to import it, select the prompt's language you want to translate, and we'll generate a template with the information.",
              "select": "Import Language:",
              "info": "Limited Options: Available options are only related to this prompt",
              "warning": "Otherwise, click '%btnCancel' button"
            }
          };
        }
      });
