          ...
          creator: function (require, exports) {
            ...
            async function checkSession(pathname) {
              ...
              if (_session.sessionWrapper.logged) {
                //@ts-ignore
                if (!_session.sessionWrapper.user.isAdmin) return {
                  pathname: '/playground'
                };
                return true;
              }
